...
<?
       ...
       $query = "SELECT * FROM cve INNER JOIN pnij WHERE cve.cpe23Uri = pnij.cpe23Uri ORDER BY LastModifiedDate  DESC LIMIT 1500";
    ...
    <div class="main-menu-area mg-tb-40">
        <div class="container">
            <div class="row">
				...
				<li><a href="addpnij.php">Configuration</a>
				</li>
				<li>
				 <form method="post" action="exporter.php">
                                               <button class="btn btn-outline-success" ><i class="fas fa-file-csv">CSV</i></button>
                                 </form>
				</li>
				<div id="liste">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>Liste des CVEs Pour la PNIJ</h2>
                        </div>
                        <dl class="dropdown">
					...
					<td style="width=400px;"><a href="https://nvd.nist.gov/vuln/detail/<?php echo htmlspecialchars($row['cve_id']); ?>"><?php echo htmlspecialchars($row['cve_id']); ?></a></td>
                                        <td><?php echo htmlspecialchars($row['cvss2_Score']); ?></td>
